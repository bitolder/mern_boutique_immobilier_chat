...
export default function About() {
  return (
    <div>
      <div className=" flex flex-col p-20 max-w-6xl mx-auto">
        <h1 className="text-slate-700 font-bold text-3xl">About Immo Estate</h1>
        <p className="text-slate-500">
          Immo Estate is a leading real estate agency that specializes in
